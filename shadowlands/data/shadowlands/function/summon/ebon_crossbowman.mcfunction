...
summon minecraft:pillager ~ ~ ~ {CustomName:{"text":"Ebon Crossbowman"},PersistenceRequired:1b,Health:100.0f,Team:"Shadow Temple",attributes:[{id:"minecraft:max_health",base:100.0},{id:"minecraft:follow_range",base:500.0},{id:"minecraft:movement_speed",base:0.2}],drop_chances:{mainhand:0.01f,offhand:0.0f}}
