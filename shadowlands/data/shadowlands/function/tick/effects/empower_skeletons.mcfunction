...
execute as @e[name="Skeleton",tag=!Empowered,x=4190,y=0,z=1240,dx=439,dy=140,dz=461] run data modify entity @s Attributes set value [        {            "Name": "max_health","Base": 20.0f},{"Name": "follow_range","Base": 500.0f},{"Name": "attack_damage","Base": 8.0f}]
