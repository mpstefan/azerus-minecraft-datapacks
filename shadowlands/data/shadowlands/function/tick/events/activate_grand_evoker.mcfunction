...
summon evoker 4501.00 32.00 1449.00 { "id": "evoker", "CustomName": "Grand Evoker", "Team": "ShadowTemple", "PersistenceRequired": 1, "Health": 1000.0f, "OnGround": 0b, "NoGravity": 1b, "Attributes": [ { "Name": "max_health", "Base": 1000.0f }, { "Name": "follow_range", "Base": 50.0f }, { "Name": "movement_speed", "Base": 0f }, { "Name": "knockback_resistance", "Base": 1.0f } ], "active_effects": [ { "Id": 10, "show_particles": 0b, "amplifier": 0, "duration": 2147483647 } ], "UUID": [I; 1107999687, 2080195132, -1955550490, 1442270264 ] }
...
execute store result bossbar grandevoker max run data get entity 420abbc7-7bfd-423c-8b70-aae655f74c38 Attributes[{"Name":"minecraft:max_health"}].Base